...
public class ViewAllRegClass extends JFrame implements ActionListener {
	private StudentMainMenu prevScreen;
	...
	public ViewAllRegClass(StudentMainMenu prevScreen, University uni , Student student) {
